...
return [
    ...
    'purchase_already_exist' => "Product can't be deleted because purchases related to this product exist",
    ...
    'variation_values_ins2' => "Values for the variation separated with '|' <br> (Ex: Red|Blue|Green)",
